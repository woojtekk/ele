...
USB_VGS     = "/dev/ttyUSB0"
USB_VDS     = "/dev/ttyUSB5"
USB_PICO    = "/dev/ttyUSB2"
#USB_SHUTTER = "/dev/ttyACM0"

#PATH	      = "/home/saw2user/inhouse/2018/run04_18_xrd_mainz/ele/"
#PATH	      = os.path.split(os.path.split(__file__)[0])[0]
PATH = "/home/mar345/ele/ele/"
print PATH
PATH_LOG      = PATH+"/log/"
PATH_DATA     = PATH+"/data/"
...
def start():
       	with open(FILE_START, 'r') as f:
		        ...
		        with open(FILE_START , 'w+') as the_file: the_file.write("STOP")
               	        return 1
		else: return 0
